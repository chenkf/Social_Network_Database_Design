...
SELECT USER_ID, FIRST_NAME, LAST_NAME,YEAR_OF_BIRTH,MONTH_OF_BIRTH,DAY_OF_BIRTH,GENDER,INSTITUTION_NAME,PROGRAM_YEAR,PROGRAM_CONCENTRATION,PROGRAM_DEGREE,CURRENT_CITY,CURRENT_STATE,CURRENT_COUNTRY,HOMETOWN_CITY FROM jsoren.PUBLIC_USER_INFORMATION MINUS SELECT USER_ID, FIRST_NAME, LAST_NAME,YEAR_OF_BIRTH,MONTH_OF_BIRTH,DAY_OF_BIRTH,GENDER,INSTITUTION_NAME,PROGRAM_YEAR,PROGRAM_CONCENTRATION,PROGRAM_DEGREE,CURRENT_CITY,CURRENT_STATE,CURRENT_COUNTRY,HOMETOWN_CITY FROM VIEW_USER_INFORMATION;
...
SELECT COUNT(*) FROM (SELECT * FROM jsoren.PUBLIC_USER_INFORMATION MINUS SELECT * FROM VIEW_USER_INFORMATION);

-----

SELECT USER_ID FROM VIEW_USER_INFORMATION WHERE ROWNUM < 20
SELECT USER_ID FROM jsoren.PUBLIC_USER_INFORMATION WHERE ROWNUM < 0
