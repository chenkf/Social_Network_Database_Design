...
SELECT se1.NEXTVAL, DISTINCT u.* FROM (SELECT CURRENT_CITY, CURRENT_STATE, CURRENT_COUNTRY FROM jsoren.PUBLIC_USER_INFORMATION 
	UNION 
SELECT HOMETOWN_CITY, HOMETOWN_STATE, HOMETOWN_COUNTRY FROM jsoren.PUBLIC_USER_INFORMATION) u
...
FROM jsoren.PUBLIC_USER_INFORMATION u and CITIES c
...
SELECT seq2.NEXTVAL, DISTINCT INSTITUTION_NAME, PROGRAM_CONCENTRATION, PROGRAM_DEGREE
FROM jsoren.PUBLIC_USER_INFORMATION

INSERT INTO EDUCATION (USER_ID, PROGRAM_ID, PROGRAM_YEAR)
SELECT u.USER_ID, p.PROGRAM_ID, u.PROGRAM_YEAR
FROM jsoren.PUBLIC_USER_INFORMATION u AND PROGRAMS p
